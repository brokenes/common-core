...
public class Ex {
     ...
     * @return
     */
    public static BusinessException business(IError error) {
        String code = error.value();
        String errorMsg = error.named();
        return new BusinessException(code,buildMessage(code,errorMsg));
    }
